...
import CustomButton, { ButtonStyle } from '../../components/CustomButton/CustomButton';
        ...
        <div className="login-form-container">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="cta-container">
              ...
              <CustomButton type="submit" buttonStyle={ButtonStyle.PRIMARY} children="Sign In"></CustomButton>
